...
%\usepackage[alf]{monografia}	             % Citações padrão ABNT
...
\input{\basePath/capitulos/intro.tex}
\input{\basePath/capitulos/objetivo.tex}
\input{\basePath/capitulos/metodo.tex}
\input{\basePath/capitulos/resultados.tex}
...
\partapendices
% ----------------------------------------------------------
\input{\basePath/apendices/site.tex}
\input{\basePath/apendices/modulos.tex}
% ----------------------------------------------------------
